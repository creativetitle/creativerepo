...
label pro4:
    ...
    scene bg_discourse with newscene #Should be a black screen

    Sris "You there, fellow wanderers! What brings you to our gates?"

    e "Save..."

    show bg_scene with quickfade #Should be Elorey drags Durs
    ...
    scene bg_discourse with newscene #Should be a lidmunds house
    ...
    scene bg_discourse with quickfade #Should be blank.

# Scene 5
label pro5:

    show bg_scene with quickfade #Should be Elorey riding
...
# Name change.
    ...
    show bg_scene with quickfade #Should be Lidmunds house
    ...
    scene bg_discourse with newscene #Should be outside lidmunds house
